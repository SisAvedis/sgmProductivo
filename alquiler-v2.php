...
<?php try{ ?>
<body>
	<form method="post" action="alquiler-v2.php" id="frm">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			<div class="row">
				...
				<table class="table table-bordered" id="tabla1">
					<thead>
						...
						<tr>	
							<th class="text-center" colspan=2>(O2) Oxígeno</th>
							<th class="text-center" colspan=2><input type="text" name="sinicialO2" id="sinicialO2" class="form-control input-sm" maxlength="3" value="<?php $sinicial; ?>" autocomplete="off"/></th>
						</tr>
						<tr>
								<th class="text-center" colspan=2>(CO2) Dióxido de Carbono</th>
								<th class="text-center" colspan=2><input type="text" name="sinicialCO2" id="sinicialCO2" class="form-control input-sm" maxlength="3" value="<?php $sinicial; ?>" autocomplete="off"/></th>						
						</tr>
						<tr>
								<th class="text-center" colspan=2>(N2O) Óxido Nitroso</th>
								<th class="text-center" colspan=2><input type="text" name="sinicialN2O" id="sinicialN2O" class="form-control input-sm" maxlength="3" value="<?php $sinicial; ?>" autocomplete="off"/></th>						
						</tr>
						<tr>
								<th class="text-center" colspan=2>(Aire) Aire</th>
								<th class="text-center" colspan=2><input type="text" name="sinicialAIM" id="sinicialAIM" class="form-control input-sm" maxlength="3" value="<?php $sinicial; ?>" autocomplete="off"/></th>						
						</tr>
			...
			if ($clienteOption){
				...
				$res = $DB->prAlquilerEnvasev4($fechaI,$fechaF,$sinicialO2,$sinicialCO2,$sinicialN2O,$sinicialAIM,$clienteid_xl[0],$tenv);

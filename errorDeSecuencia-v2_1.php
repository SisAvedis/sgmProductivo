...
<body>
	<form method="post" action="errorDeSecuencia-v2_1.php">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div id="tit" class="col-sm-6"><h4>Errores de Secuencia de Entregas y Devoluciones v2_1</h4></div>
                </div>
            </div>
			...
			if ($clienteOption){
				...
				//echo "</pre>";
				$res = $DB->prErrorDeSecuenciav2_1($fechaI,$fechaF,$clienteid_xl[0], $propiedad, $tenv);
				...
				?>
					<tbody>
						<tr>
							...
							<td "text-right"><?php if(isset($row->serie)){echo $row->volumen;}else{echo "Error";}?></td>

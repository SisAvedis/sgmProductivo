			...
			while($row = mysqli_fetch_array($res)){
				...
				if($tipo == 'CIL' || $tipo == 'TER'){
					...
					$select_arr[0] = "<label><pre class='lx-pre'>Cliente</pre></label>"."</br>"."<label><pre class='lx-pre'><select name='cliente' id='cliente' class='form-control input-sm'>"."<option value='0'>Clientes</option>";
						...
						$header16 = "Seleccione la Acción";
						$header17 = "<label><pre class='lx-pre'>Tipo de Acción</pre></label>"."</br>"."<label><pre class='lx-pre' id='lblEliminar'>Eliminar <input type='radio' class='oTM' name='tipoMovimiento' value='DE' required /></pre></label><label><pre class='lx-pre' id='lblModificar'>Modificar  <input type='radio' class='oTM' name='tipoMovimiento' value='UP' required  /></pre></label>";
						
						
						
					$return_arr[] = array("header1" => $header1, "header2" => $header2, "header3" => $header3, "header4" => $header4, "header5" => $header5, "header6" => $header6, "header7" => $header7, "header8" => $header8, "header9" => $header9, "header10" => $header10, "header11" => $header11, "header12" => $header12, "header13" => $header13, "header16" => $header16, "header17" => $header17);		
					...
					$header4 = "<label><pre class='lx-pre'>Partida</pre></label>"."</br>"."<label><pre class='lx-pre'><input type='text' name='part' id='part' class='form-control input-sm' maxlength=6  autocomplete='off' /></pre></label>";
				...
				$header1 = "Atención. El remito número ".$nremito." no fue ingresado";
				$header2 = "Sin Datos";
				$header13 = true;
				$return_arr[] = array("header1" => $header1, "header2" => $header2, "header13" => $header13);
				echo json_encode($return_arr);
			}	
				}else{

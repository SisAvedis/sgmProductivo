...
<?php try{ ?>
<body>
	<form method="post" action="remitoBM-v1.php" id="frm">
    <div class="container">
		<!-- HEADER (start) -->
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST'){
			...
			if($tipo <> "Granel"){
				...
				if ($bmOpcion == "B"){
					...
					$res = $DB->prBMRemitoLGv1($fecha,$fecha,$nremito,$nremito,$nid_xl,$nid_xl,$pr,$pr,$tipo,$bmOpcion,$idusuario);
					...
					$res = $DB->prBMRemitoLGv1($fecha,$fechaM,$nremito,$nremitomodi,$nid_xl,$clienteid[0],$pr,$prM,$tipo,$bmOpcion,$idusuario);
					$row_cnt = mysqli_num_rows($res);
				}
				?>

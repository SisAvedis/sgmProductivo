<?php
	...
	class Database{
		...
		//Ok - Para Detonar
		public function prBMRemitoLGv12($id1,$id2,$id3,$id4,$id5,$id6,$id7,$id8,$id9,$id10,$id11){
			$sql = "CALL prBMRemitoLGv12('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."','".$id6."','".$id7."','".$id8."'
										,'".$id9."','".$id10."','".$id11."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		...
		//Ok - para detonar
		public function prInsertarCSVv66($id1,$id2,$id3,$id4,$id5,$id6,$id7,$id8,$id9,$id10){
			$sql = "CALL prInsertarCSVv66('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."','".$id6."','".$id7."','".$id8."','".$id9."','".$id10."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok

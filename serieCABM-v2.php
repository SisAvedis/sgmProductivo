...
<body>
	<form method="post" action="serieCABM-v2.php" id="frm">
    <div class="container">
		<!-- HEADER (start) -->
			...
			*/
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST'){
				if ($nradio == "A"){
					...
					$res = $DB->prABMSeriev2($nremito,$envdev,$nserie,$capacidad[0],$nradio,$idusuario);
					...
					//echo "</pre>";
					$res = $DB->prABMSeriev2($nremito,$envdev,$nserie,$capacidad[0],$nradio,$idusuario);
					//$res = $DB->prABMSeriev2($nremito,$envdev,$nserie,$scapacidad,$nradio);
					$row_cnt = mysqli_num_rows($res);
					if ($row_cnt == 0){
					...
					$res = $DB->prABMSeriev2($nremito,$envdev,$nserieTotal,$capacidad[0],$nradio,$idusuario);
					$row_cnt = mysqli_num_rows($res);
					if ($row_cnt == 0){

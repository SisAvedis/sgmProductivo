...
<body>
	<form method="post" action="cHits-v3.php" id="frm">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
				...
				<table class="table table-bordered" id="tabla2">
					...
					<tbody>	
						<tr>
							...
							<th><input type="text" name="cantidad" id="cantidad" class='form-control input-sm' maxlength="2" autocomplete="off" required /><?php $cantidad ?></th>
						</tr>
					</tbody>
				</table>
				</div>
			...
			if(validaNumero($clienteOption && $cantidad)){
				...
				$DB= new Database();
				$res = $DB->prRepeticionesSeriev2($fechaI,$fechaF,$clienteid_xl[0],$cantidad);

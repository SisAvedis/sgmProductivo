...
<?php try{ ?>
<body>
	<form method="post" action="auditoria-v2.php" id="frm">
    <div class="container">
		<!-- HEADER (start) -->
	...
	<?php
			if ($_SERVER['REQUEST_METHOD'] == 'POST'){
				...
				$res = $DB->prInsertarAUCSVv2($fecha,$clienteid[1],$seriesCSV,$clienteid[0],$idusuario);
...
<script type="text/javascript">
	...
	function getEnvaseCliente(sDate, sCliente, callbackFn){
		jq.ajax({
			url:"./ajaxEnvaseAuditoria-v2.php",
			dataType: "json",

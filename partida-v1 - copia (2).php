				...
				<table class="table table-bordered" id="tabla">
					<thead>
						<tr>
							...
							<th class="text-center" colspan=2>Completar</th>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="text-center" rowspan=4><input type="radio" class="abmOpcion" name="abmOpcion" value="K" required <?php //echo ($nradio=='K')?'checked':'' ?> /></td>
						</tr>
						<tr >
							<th class="text-center">Fecha Inicial</th>
							<th class="text-center" colspan=2><input type="text" name="fechaI" id="datepickerI" class="form-control input-sm" maxlength="10" autocomplete="off" required /></th>
							
						</tr>
						<tr>
							<th class="text-center">Fecha Final</th>
							<th class="text-center" colspan=2><input type="text" name="fechaF" id="datepickerF" class="form-control input-sm" maxlength="10" autocomplete="off" required /></th>
						</tr>

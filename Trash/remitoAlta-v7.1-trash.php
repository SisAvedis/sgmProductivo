...
<?php try{ ?>
<body>
	<form method="post" action="remitoAlta-v7.1-trash.php" id="frm" >
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			if($otipoProducto && $otipoProducto == 'LG' && validaSerie($nremito)){
				...
				$res = $DB->prInsertarCSVv66($fecha,$nremito,$clienteid[1],$seriesCSV,$prop,$tipoenvase,$clienteid[0],$tipoRemito,$idusuario);

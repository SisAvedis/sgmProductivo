...
<?php try{ ?>
<body>
	<form method="post" action="kardex-v4.php">
	...
	<div class="container">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div id="tit" class="col-sm-8"><h4>Kardex v4</h4></div>
                </div>
            </div>
			...
			if ($clienteOption && $tipoinf && $idproductoOption){
				...
				if ($tipoinf == "D"){
					$tinf = 'Detalle';
					$res = $DB->prKardexv4($fechaI,$fechaF,$clienteid_xl[0],2, $propiedad, $tenv, $producto[0]);
				}elseif ($tipoinf == "R"){
					$res = $DB->prKardexv4($fechaI,$fechaF,$clienteid_xl[0],1, $propiedad, $tenv, $producto[0]);
					$tinf = 'Resumen';
				}

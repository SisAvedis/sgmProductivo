...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if($row_cnt == 0){
		...
		for($tre=0;$tre<$row_cnt;$tre++){
			...
			$header1 = $header1."<td><pre class='lx-pre'><input type='text' name='".$sFEC."' class='form-control input-sm' id='".$sFEC."' maxlength=15  autocomplete='off' value=".$audit_arr[$tre][5]." disabled/></pre><input type='hidden' value=".$audit_arr[$tre][5]." name='".$sFEH."' id='".$sFEH."'/></td>";
			$header1 = $header1."<td><pre class='lx-pre'><input type='text' name='".$sREM."' class='form-control input-sm' id='".$sREM."' maxlength=15  autocomplete='off' value=".$audit_arr[$tre][6]." disabled/></pre><input type='hidden' value=".$audit_arr[$tre][6]." name='".$sREH."' id='".$sREH."'/></td>";			

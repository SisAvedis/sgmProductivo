...
<?php try{ ?>
<body>
	<form method="post" action="alquiler-v3.php" id="frm">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			if ($clienteOption){
				...
				$res = $DB->prAlquilerEnvasev5($fechaI,$fechaF,$sinicialO2,$sinicialCO2,$sinicialN2O,$sinicialAIM,$clienteid_xl[0],$tenv,$comp);

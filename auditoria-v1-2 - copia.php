			...
			bootbox.confirm(
				...
				if(result){
					...
					if (sSerie !== ''){
						...
						//remito
						var newRow = newRow+"<td><pre class='lx-pre'><input type='text' name='"+sREM+"' class='form-control input-sm' id='"+sREM+"' maxlength=15  autocomplete='off' value='' disabled /></pre><input type='hidden' value='-' name='"+sREH+"' id='"+sREH+"'/></td>";
						//serie

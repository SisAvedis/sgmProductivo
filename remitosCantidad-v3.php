...
<?php try{ ?>
<body>
	<form method="post" action="remitosCantidad-v3.php">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			if ($clienteOption && $tipoinf){
				...
				if ($tipoinf == "R"){
					$tinf = 'Resumen';
					$res = $DB->prRemitosCantidadv3($fechaI,$fechaF,$clienteid_xl[0],1, $propiedad, $tenv, $tiporemito);
				}elseif ($tipoinf == "D"){
					$res = $DB->prRemitosCantidadv3($fechaI,$fechaF,$clienteid_xl[0],2, $propiedad, $tenv, $tiporemito);
					$tinf = 'Detalle';
				}

    ...
    switch($_GET["op"])
    {
        ...
        case 'verificar':
			 ...
			 if(isset($fetch))
            {
				...
				in_array(41,$valores) ? $_SESSION['Remito Estado'] = 1 : $_SESSION['Remito Estado'] = 0;
				in_array(42,$valores) ? $_SESSION['Remito Estado GE'] = 1 : $_SESSION['Remito Estado GE'] = 0;
				in_array(43,$valores) ? $_SESSION['Kardex GE'] = 1 : $_SESSION['Kardex GE'] = 0;
				in_array(44,$valores) ? $_SESSION['Certificados GE'] = 1 : $_SESSION['Certificados GE'] = 0;
				in_array(45,$valores) ? $_SESSION['Consulta Auditoria GE'] = 1 : $_SESSION['Consulta Auditoria GE'] = 0;
				in_array(46,$valores) ? $_SESSION['Primero D GE'] = 1 : $_SESSION['Primero D GE'] = 0;
				in_array(47,$valores) ? $_SESSION['Lotes Alfa'] = 1 : $_SESSION['Lotes Alfa'] = 0;
				in_array(48,$valores) ? $_SESSION['Historial Llenado Alfa'] = 1 : $_SESSION['Historial Llenado Alfa'] = 0;
				in_array(49,$valores) ? $_SESSION['Auditoria'] = 1 : $_SESSION['Auditoria'] = 0;
				in_array(50,$valores) ? $_SESSION['Auditoria GE'] = 1 : $_SESSION['Auditoria GE'] = 0;
				in_array(51,$valores) ? $_SESSION['Consulta Auditoria'] = 1 : $_SESSION['Consulta Auditoria'] = 0;
				in_array(52,$valores) ? $_SESSION['Envases Cliente GE MS'] = 1 : $_SESSION['Envases Cliente GE MS'] = 0;
				in_array(53,$valores) ? $_SESSION['Envases Cliente (Cap) GE MS'] = 1 : $_SESSION['Envases Cliente (Cap) GE MS'] = 0;
				in_array(54,$valores) ? $_SESSION['Error Secuencia GE MS'] = 1 : $_SESSION['Error Secuencia GE MS'] = 0;
				in_array(55,$valores) ? $_SESSION['Serie (Repeticiones) GE'] = 1 : $_SESSION['Serie (Repeticiones) GE'] = 0;
				in_array(56,$valores) ? $_SESSION['Remitos Cant-ED v2 GE MS'] = 1 : $_SESSION['Remitos Cant-ED v2 GE MS'] = 0;
				in_array(57,$valores) ? $_SESSION['M Auditoria'] = 1 : $_SESSION['M Auditoria'] = 0;
				in_array(57,$valores) ? $_SESSION['M Auditoria GE'] = 1 : $_SESSION['M Auditoria GE'] = 0;
			}

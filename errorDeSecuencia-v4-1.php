...
<body>
	<form method="post" action="errorDeSecuencia-v4-1.php">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			$clienteOption = isset($_POST['cliente']) ? $_POST['cliente'] : false;;
			$idproductoOption = isset($_POST['idproducto']) ? $_POST['idproducto'] : false;;
			if ($clienteOption && $idproductoOption){
				//echo print_r($_POST);
				...
				//echo "</pre>";
				$res = $DB->prErrorDeSecuenciav4($fechaI,$fechaF,$clienteid_xl[0], $propiedad, $tenv, $producto[0]);
				...
				$message= "Se obtuvieron ".$row_cnt. " registros. (Desde: ".$fechaI." Hasta: ".$fechaF.") Cliente: (".$clienteid_xl[0].") ".$clienteid_xl[1].". Propiedad: ".$propiedad.". Envase: ".$tenv.". Producto: (".$producto[1].") ".$producto[2];
				if ($row_cnt == 0){
						$class="alert alert-info";
					}elseif ($row_cnt == 1){
						$brow_cnt = true;
						$message= "Se obtuvo ".$row_cnt." registro. Cliente: (".$clienteid_xl[0].") ".$clienteid_xl[1].". Propiedad: ".$propiedad.". Envase: ".$tenv.". Producto: (".$producto[1].") ".$producto[2];

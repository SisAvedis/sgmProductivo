	...
	if($nremito && $bremito) {
		...
		if($row_cnt > 0){
			...
			if($tipo == 'CIL' || $tipo == 'TER'){
				...
				$header1 = "Atención. El remito número ".$nremito." ya fue ingresado";
				$header2 = "Fecha: ".$fecha." | Cliente: (".$id_xl.") ".$clie." | Tipo: ".$tipof." | Volumen: ".$env;
			}
			...
			$return_arr[] = array("header1" => $header1, "header2" => $header2, "header7" => $header7, "header8" => $header8, "header10" => $header10);
				...
				$header2 = "Seleccione el tipo de producto";
				...
				$header4 = "Listo";
				$header5 = "Indica si el remito se puede confirmar. Valores Si/No";
				$header6 = "No";
				$header7 = "col-md-4";	//Tipo de Producto (Etiquetas + Botines Opción)
				$header8 = "col-md-5";	//Etiqueta Listo (Si/No)
				
				$header10 = false;
			
				$return_arr[] = array("header1" => $header1, "header2" => $header2, "header3" => $header3, "header4" => $header4, "header5" => $header5, "header6" => $header6, "header7" => $header7, "header8" => $header8, "header10" => $header10);
					echo json_encode($return_arr);
			}	
		}else{
			...
			$header10 = true;
			$return_arr[] = array("header1" => $header1, "header2" => $header2, "header10" => $header10);
			echo json_encode($return_arr);
			}
	}
?>

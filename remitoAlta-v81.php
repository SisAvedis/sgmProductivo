...
<?php try{ ?>
<body>
	<form method="post" action="remitoAlta-v81.php" id="frm" >
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			if($otipoProducto && $otipoProducto == 'LG' && $productoid && validaSerie($nremito)){
				$envS = 0;
				$devS = 0;
				$ecapH = 0;
				$dcapH = 0;
				...
				$res = $DB->prInsertarCSVv7($fecha,$nremito,$clienteid[1],$productoid[0],$productoid[1],$seriesCSV,$prop,$tipoenvase,$clienteid[0],$tipoRemito,$motivo,$idusuario);

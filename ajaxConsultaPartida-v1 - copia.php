	...
	if($row_cnt > 0){
		...
		for($tre=0;$tre<$row_cnt;$tre++){
			...
			if($tre<10){
				...
				if($t_arr[$tre][1] !== "N/D"){
					$header1 = $header1."<td><pre class='lx-pre'><input type='text' name='PAR0".strval($tre)."' class='form-control input-sm' id='PAR0".strval($tre)."' maxlength=5  autocomplete='off' value=".$t_arr[$tre][1]." disabled/></pre></td>";
				}else{
					$header1 = $header1."<td><pre class='lx-pre'><input type='text' name='PAR0".strval($tre)."' class='form-control input-sm' id='PAR0".strval($tre)."' maxlength=5  autocomplete='off' /></pre></td>";
				}
				if($t_arr[$tre][2] !== "N/D"){

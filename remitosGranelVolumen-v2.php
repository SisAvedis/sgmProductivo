...
<?php try{ ?>
<body>
	<form method="post" action="remitosGranelVolumen-v2.php">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			if ($clienteOption && $tipoinf){
				...
				if ($tipoinf == "R"){
					$tinf = 'Resumen';
					$res = $DB->prRemitosGranelv2($fechaI,$fechaF,$clienteid_xl[0],1,"ZZZ");
				}elseif ($tipoinf == "D"){
					$res = $DB->prRemitosGranelv2($fechaI,$fechaF,$clienteid_xl[0],2,"ZZZ");
					$tinf = 'Detalle';
				}

...
<?php try{ ?>
<body>
	<form method="post" action="auditoria-v1-2.php" id="frm">
    <div class="container">
		<!-- HEADER (start) -->
...
<script type="text/javascript">
	...
	function getEnvaseCliente(sDate, sCliente, callbackFn){
		jq.ajax({
			url:"./ajaxEnvaseAuditoria-v1-2.php",
			dataType: "json",
			...
			bootbox.confirm(
				...
				if(result){
					...
					if (sSerie !== ''){
						...
						var sTipo = "M";
						//fecha
						var newRow = "<tr class='TRs' id='"+sTR+"'><td><pre class='lx-pre'><input type='text' name='"+sFEC+"' class='form-control input-sm' id='"+sFEC+"' maxlength=15  autocomplete='off' value=''disabled /></pre><input type='hidden' value='-' name='"+sFEH+"' id='"+sFEH+"'/></td>";
						//remito

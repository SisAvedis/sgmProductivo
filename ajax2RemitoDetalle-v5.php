...
if($nremito && $bremito) {
	...
	$res = $DB->prRemitoDetallev9($nremito);
	...
	if($row_cnt == 0){
		...
		if($nradioval == "M"){
			$header11 = true;
			$header12 = "<label><pre class='lx-pre'>Remito (Nuevo Número)</pre></label>"."</br>"."<label><pre class='lx-pre'><input type='text' name='nremitomodi' id='nremitomodi' class='form-control input-sm' maxlength='13' autocomplete='off' required/></pre></label>";
			...
			if($sTipo == "Granel"){
				...
				$header16 = "<label><pre class='lx-pre'>Partida</pre></label>"."</br>"."<label><pre class='lx-pre'><input type='text' name='part' id='part' class='form-control input-sm' maxlength=12  autocomplete='off' /></pre></label>";

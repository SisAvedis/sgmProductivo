...
<?php try{ ?>
<body>
	<form method="post" action="kardex-v3.php">
	...
	<div class="container">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div id="tit" class="col-sm-8"><h4>Kardex v3</h4></div>
                </div>
            </div>
			...
			if ($clienteOption && $tipoinf){
				...
				if ($tipoinf == "D"){
					$tinf = 'Detalle';
					$res = $DB->prKardexv3($fechaI,$fechaF,$clienteid_xl[0],2, $propiedad, $tenv);
				}elseif ($tipoinf == "R"){
					$res = $DB->prKardexv3($fechaI,$fechaF,$clienteid_xl[0],1, $propiedad, $tenv);
					$tinf = 'Resumen';
				}

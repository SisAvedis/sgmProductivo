...
<?php try{ ?>
<body>
	<form method="post" action="remitoAlta-v7.3.php" id="frm" >
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			if($otipoProducto && $otipoProducto == 'LG' && validaSerie($nremito)){
				...
				$res = $DB->prInsertarCSVv63($fecha,$nremito,$clienteid[1],$seriesCSV,$prop,$tipoenvase,$clienteid[0],$tipoRemito,$motivo,$idusuario);
				...
				<?php
						...
						$res = $DB->prInsertarGRv13($fecha,$nremito,$clienteid[1],$estado,$serie,$volumen,$prop,$tipoenvase,$clienteid[0],$partida,$certificado,$tdestino[0],$tipoRemito,$idusuario);
						$row_cnt = mysqli_num_rows($res);
						if ($row_cnt == 0){
							$message= "No se insertaron movimientos";
							$class="alert alert-info";

	...
	if($nremito && $bremito) {
		...
		if($row_cnt == 0){
			...
			$select_arr[0] = "<label><pre class='lx-pre'>Cliente</pre></label>"."</br>"."<label><pre class='lx-pre'><select name='cliente' id='cliente' class='form-control input-sm'>"."<option value='0'>Clientes</option>";
				...
				$headerA = "Listo";
				$headerB = "Indica si el remito se puede confirmar. Valores Si/No";
				$headerC = "No";
				$headerD = "col-md-5";	//Etiqueta Listo (Si/No)
												
			$return_arr[] = array("header1" => $header1, "header2" => $header2, "header3" => $header3, "header4" => $header4, "header5" => $header5, "header6" => $header6, "header7" => $header7, "header8" => $header8, "header9" => $header9, "header10" => $header10, "header11" => $header11, "header12" => $header12, "header13" => $header13, "headerA" => $headerA, "headerB" => $headerB, "headerC" => $headerC, "headerD" => $headerD);		

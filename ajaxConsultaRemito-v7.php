		...
		if($row_cnt == 0){
				...
				if($tipoProducto == 'LG'){
					...
					$select_arr[0] = "<label><pre class='lx-pre'>Cliente</pre></label>"."</br>"."<label><pre class='lx-pre'><select name='cliente' id='cliente' class='form-control input-sm'>"."<option value='0'>Clientes</option>";
						...
						$header3 = "<label><pre class='lx-pre'>Tipo</pre></label>"."</br>"."<label><pre class='lx-pre'><input type='radio' name='env' value='CIL' class='envRadio' required checked/>CIL<input type='radio' name='env' value='TER' class='envRadio' required/>TER<input type='hidden' name='mot' id='mot'/></pre></label>";

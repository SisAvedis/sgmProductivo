...
<?php try{ ?>
<body>
	<form method="post" action="remitosCantidad-v2.php">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			if ($clienteOption && $tipoinf){
				...
				if ($tipoinf == "R"){
					$tinf = 'Resumen';
					$res = $DB->prRemitosCantidadv2($fechaI,$fechaF,$clienteid_xl[0],1, $propiedad, $tenv);
				}elseif ($tipoinf == "D"){
					$res = $DB->prRemitosCantidadv2($fechaI,$fechaF,$clienteid_xl[0],2, $propiedad, $tenv);
					$tinf = 'Detalle';
				}

...
<?php try{ ?>
<body>
	<form method="post" action="remitoBM-v2.php" id="frm">
    <div class="container">
		<!-- HEADER (start) -->
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST'){
			...
			if($tipo <> "Granel"){
				...
				if ($bmOpcion == "B"){
					...
					$res = $DB->prBMRemitoLGv2($fecha,$fecha,$nremito,$nremito,$nid_xl,$nid_xl,$pr,$pr,$tipo,$bmOpcion,$idusuario);
					...
					$res = $DB->prBMRemitoLGv2($fecha,$fechaM,$nremito,$nremitomodi,$nid_xl,$clienteid[0],$pr,$prM,$tipo,$bmOpcion,$idusuario);
					$row_cnt = mysqli_num_rows($res);
				}
				?>
			...
			<?php		
				...
				if ($bmOpcion == "B"){
					...
					$res = $DB->prBMRemitoGRv2($fecha,$fecha,$nremito,$nremito,$nid_xl,$nid_xl,$vopacetaid[0],$vopacetaid[0],
					...
					$res = $DB->prBMRemitoGRv2($fecha,$fechaM,$nremito,$nremitomodi,$nid_xl,$clienteid[0],$vopacetaid[0],$vol,

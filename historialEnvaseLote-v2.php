...
<?php try{ ?>
<body>
	<form method="post" action="historialEnvaseLote-v2.php">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST'){
				if(validaSerie($nserie)){
					...
					$res = $DB->prhistorialEnvaseLotev11($nserie, $propiedad, $tenv, $tipoinf);
					//echo "<pre>";
					//echo $res."</br>";
					//echo "<pre>";
				...
				?>
					<tbody>
						<tr>
							...
							<td class="text-right"><?php if(isset($row->LotePartida)){echo $row->LotePartida;}else{echo "Error";}?></td>

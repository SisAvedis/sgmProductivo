...
<?php try{ ?>
<body>
	<form method="post" action="UltimoEnviado-v31.php">
    <div class="container">
		<!-- HEADER (start) -->
        ...
        <div class="table-wrapper">
			...
			<div class="row">
				...
				<table class="table table-bordered" id="tabla1">
					<thead>
						...
						<tr>
							<th>Ultimo_E</th><th>Ultimo_D</th><th>Cantidad</th><th>Envases</th><th>NP </th><th>SP</th><th>NP+SP</th><th>CIL</th><th>TER</th>
						</tr>
						<tr>
			...
			if ($clienteOption && $detallepor){
				...
				$res = $DB->prinUltimoEnviadov31($fecha,$clienteid_xl[0],$detallepor,$propiedad,$tenv,$estado,1);

			...
			*/
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST'){
				if ($nradio == "A"){
					...
					$res = $DB->prABMSeriev1($nremito,$envdev,$nserie,$capacidad[0],$nradio,$idusuario);
					...
					//echo "</pre>";
					$res = $DB->prABMSeriev1($nremito,$envdev,$nserie,$scapacidad,$nradio,$idusuario);
					...
					$res = $DB->prABMSeriev1($nremito,$envdev,$nserieTotal,$capacidad[0],$nradio,$idusuario);
					$row_cnt = mysqli_num_rows($res);
					if ($row_cnt == 0){
			...
			jq.ajax({
				...
				success:function(response){
					...
					for(var i=0; i<len; i++){
						...
						console.log("bSerieVal -> "+bSerieVal+" |-| bSerieModiVal -> "+bSerieModiVal);

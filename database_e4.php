<?php
	...
	class Database{
		...
		//Ok-v3	
		public function prinUltimoEnviadov5($fecha,$id_xl,$qr,$v_pr,$v_te,$es,$tproc,$v_idproducto){
			$sql = "CALL prinUltimoEnviadov5('".$fecha."','".$id_xl."','".$qr."','".$v_pr."','".$v_te."','".$es."','".$tproc."','".$v_idproducto."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3	
		public function prUltimoEnviadoCCv5($fecha,$id_xl,$qr,$v_pr,$v_te,$es,$v_idproducto){
			$sql = "CALL prUltimoEnviadoCCv5('".$fecha."','".$id_xl."','".$qr."','".$v_pr."','".$v_te."','".$es."','".$v_idproducto."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok 		
		...
		//Ok-v3
		public function prCertificadov3($id1,$id2){
			$sql = "CALL prCertificadov3('".$id1."','".$id2."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok -
		...
		//Ok-v3		
		public function prhistorialEnvaseLotev11($id1,$id2,$id3,$id4){
			$sql = "CALL prhistorialEnvaseLotev11('".$id1."','".$id2."','".$id3."','".$id4."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prEnvasesLotev11($id1){
			$sql = "CALL prEnvasesLotev11('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prLotesFechav11($id1,$id2){
			$sql = "CALL prLotesFechav11('".$id1."','".$id2."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok		
		...
		//Ok-v3		
		public function prAlquilerEnvasev6($id1,$id2,$id3,$id4,$id5,$id6,$id7,$id8,$id9){
			$sql = "CALL prAlquilerEnvasev6('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."','".$id6."','".$id7."','".$id8."','".$id9."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prBMRemitoLGv3($id1,$id2,$id3,$id4,$id5,$id6,$id7,$id8,$id9,$id10,$id11){
			$sql = "CALL prBMRemitoLGv3('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."','".$id6."','".$id7."','".$id8."'
										,'".$id9."','".$id10."','".$id11."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		...
		//Ok-v3
		public function prBMRemitoGRv3($id1,$id2,$id3,$id4,$id5,$id6,$id7,$id8,$id9,$id10,$id11,$id12,$id13,$id14,$id15,$id16){
			$sql = "CALL prBMRemitoGRv3('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."','".$id6."','".$id7."','".$id8."'
										,'".$id9."','".$id10."','".$id11."','".$id12."','".$id13."','".$id14."','".$id15."'
										,'".$id16."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		...
		//Ok-v3
		public function prActualizarEstadov3($id1,$id2,$id3){
			$sql = "CALL prActualizarEstadov3('".$id1."','".$id2."','".$id3."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prRemitoDetallev53($id1){
			$sql = "CALL prRemitoDetallev53('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v3
		public function prRemitoDetallev63($id1){
			$sql = "CALL prRemitoDetallev63('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v2
		...
		//Ok-v3
		public function prRemitoDetallev8($id1){
			$sql = "CALL prRemitoDetallev8('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v2
		...
		//Ok-v3
		public function prRemitoDetallev7($id1){
			$sql = "CALL prRemitoDetallev7('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v3
		public function prRemitoDetallev9($id1){
			$sql = "CALL prRemitoDetallev9('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v2
		...
		//Ok-v3
		public function prRemitoProductov2($id1){
			$sql = "CALL prRemitoProductov2('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v2
		...
		//Ok-v3
		public function prInsertarCSVv8($id1,$id2,$id3,$id4,$id5,$id6,$id7,$id8,$id9,$id10,$id11,$id12){
			$sql = "CALL prInsertarCSVv8('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."','".$id6."','".$id7."','".$id8."','".$id9."','".$id10."','".$id11."','".$id12."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prInsertarCSVSIv8($id1,$id2,$id3,$id4,$id5,$id6,$id7,$id8,$id9,$id10,$id11){
			$sql = "CALL prInsertarCSVSIv8('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."','".$id6."','".$id7."','".$id8."','".$id9."','".$id10."','".$id11."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v2
		...
		//Ok-v3
		public function prInsertarGRv3($id1,$id2,$id3,$id4,$id5,$id6,$id7,$id8,$id9,$id10,$id11,$id12,$id13,$id14,$id15,$id16){
			$sql = "CALL prInsertarGRv3('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."','".$id6."','".$id7."','".$id8."','".$id9."','".$id10."','".$id11."','".$id12."','".$id13."','".$id14."','".$id15."','".$id16."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		public function prInsertarAUCSVv1($id1,$id2,$id3,$id4,$id5){
			$sql = "CALL prInsertarAUCSVv1('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v3
		public function prInsertarAUCSVv2($id1,$id2,$id3,$id4){
			$sql = "CALL prInsertarAUCSVv2('".$id1."','".$id2."','".$id3."','".$id4."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prConsultarAuditoriasv2($id1,$id2,$id3){
			$sql = "CALL prConsultarAuditoriasv2('".$id1."','".$id2."','".$id3."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prSerieExistev4($id1,$id2,$id3,$id4,$id5){
			$sql = "CALL prSerieExistev4('".$id1."','".$id2."','".$id3."','".$id4."','".$id5."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prConsultaPCTv3($id1,$id2,$id3){
			$sql = "CALL prConsultaPCTv3('".$id1."','".$id2."','".$id3."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok-v3
		public function prConsultaPCTv4($id1){
			$sql = "CALL prConsultaPCTv4('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prActualizaPCTv2($id1){
			$sql = "CALL prActualizaPCTv2('".$id1."')";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
		...
		//Ok-v3
		public function prGetNumeroRemitov3(){
			$sql = "CALL prGetNumeroRemitov3";
			$res = mysqli_query($this->con, $sql);
			return $res;
		}
		//Ok
